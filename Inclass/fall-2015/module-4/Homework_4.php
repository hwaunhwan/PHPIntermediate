...
// Card, Deck, Player, Dealer =====> classes

// Card = suite, rank, color, how it looks (method to draw)
// Deck = 52, card[] ....([]means plural), shuffle (); giveCard();
// Player = name, card[], receiveCard (Card $card)
// Dealer = Deck (card[]), deals(); deals() calls shuffle()=deck::shuffle, deck::getCard(); give card

//All objects are passed around by reference!! no need for '&'
//use array_pop instead of unset
