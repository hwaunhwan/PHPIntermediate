...
3. How to get the value from the class on player.php line 60
...
<div id="wrapper">
    ...
    <div id="header" class="width_1000">
        ...
        <form action="index.php" method="POST">
            <input type="text" name="name" value="Enter your first name" onclick="this.value=''"><br>

            <input type="submit" name="submit" value="Enter!"> <!-- once you click submit, it will run HW 1.php -->
        </form>
    <?php
