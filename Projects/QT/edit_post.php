...
<form action = "edit_post.php"
      method = "POST">
    <input type="text" name="title" size="82" placeholder="말씀" value="<?php echo $title ?>"><br><br>
    <input type="text" name="author" size="82" placeholder="제목" value="<?php echo $author ?>"><br><br>
    <textarea name="contents" rows="25" cols="80"><?php echo $contents //onclick="this.value=''" to textarea?></textarea><br><br>
...
foreach ($result as $row) {
    $disp = substr($row['contents'],0,20);
    echo "<pre>";
    echo "Title:     $row[title]<br>Author:    $row[author]<br>Date:      $row[date]<br>Contents:  $disp...<br><br><br></pre>";
}?>
    </td>
</table>
</body>